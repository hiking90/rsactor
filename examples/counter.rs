...
extern crate rsactor;

use rsactor::{actor, system, Errors, IActor, IMessage, System};
...
impl IMessage for CounterMessage {}

impl IActor for Counter {
...
async fn main() {
    ...
    let (actor, handle) = system.spawn(Some("test_name".to_string()), Counter)
        .await
